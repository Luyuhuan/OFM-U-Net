...
# nnUNet_preprocessed = r"/root/lzz2/cardiac_cycle/mamba/U-Mamba/data/nnUNet_preprocessed"
nnUNet_results = join(base, 'nnUNet_resultsfc_success_192x192_mamba') # os.environ.get('nnUNet_results')
